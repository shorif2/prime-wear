import { c as createComponent, b as createAstro, m as maybeRenderHead, a as renderComponent, r as renderTemplate, d as addAttribute, F as Fragment } from '../../chunks/astro/server_BTOzv46n.mjs';
import 'kleur/colors';
...
</p> <div class="mt-4" data-astro-cid-gpp6xnpz> <h3 class="text-sm text-gray-800 uppercase mb-1" data-astro-cid-gpp6xnpz>Quantity</h3> <label for="quantity" class="sr-only" data-astro-cid-gpp6xnpz>Product quantity</label> <div class="flex text-gray-600 divide-x divide-gray-300 w-max" data-astro-cid-gpp6xnpz> <button type="button" id="quantity-minus" class="h-8 w-8 border border-gray-300 text-xl flex items-center justify-center cursor-pointer select-none" aria-label="Decrease quantity" data-astro-cid-gpp6xnpz>
-
</button> <input type="number" id="quantity" name="quantity" min="1" value="1" aria-label="Product quantity" class="h-8 w-14 text-center text-base flex items-center justify-center no-spinner" data-astro-cid-gpp6xnpz> <button type="button" id="quantity-plus" class="h-8 w-8 text-xl flex items-center justify-center cursor-pointer select-none border border-gray-300" aria-label="Increase quantity" data-astro-cid-gpp6xnpz>
+
</button> </div> </div> <!-- cart action --> <div class="mt-6 flex gap-3 border-b border-gray-200 pb-5 pt-5" data-astro-cid-gpp6xnpz> <a href="#" class="bg-primary border border-primary text-white px-8 py-2 font-medium rounded uppercase flex items-center gap-2 hover:bg-transparent hover:text-primary transition" data-astro-cid-gpp6xnpz> <i class="fa-solid fa-bag-shopping" data-astro-cid-gpp6xnpz></i> Add to cart
</a> <a href="#" class="border border-gray-300 text-gray-600 px-8 py-2 font-medium rounded uppercase flex items-center gap-2 hover:text-primary transition" data-astro-cid-gpp6xnpz> <i class="fa-solid fa-heart" data-astro-cid-gpp6xnpz></i> Wishlist
</a> </div> <div class="flex gap-3 mt-4" data-astro-cid-gpp6xnpz> <a href="#" class="text-gray-400 hover:text-gray-500 h-8 w-8 rounded-full border border-gray-300 flex items-center justify-center" data-astro-cid-gpp6xnpz> <i class="fa-brands fa-facebook-f" data-astro-cid-gpp6xnpz></i> </a> <a href="#" class="text-gray-400 hover:text-gray-500 h-8 w-8 rounded-full border border-gray-300 flex items-center justify-center" data-astro-cid-gpp6xnpz> <i class="fa-brands fa-twitter" data-astro-cid-gpp6xnpz></i> </a> <a href="#" class="text-gray-400 hover:text-gray-500 h-8 w-8 rounded-full border border-gray-300 flex items-center justify-center" data-astro-cid-gpp6xnpz> <i class="fa-brands fa-instagram" data-astro-cid-gpp6xnpz></i> </a> </div> </div> </main> `;
...
Related products
</h2> <div class="grid grid-cols-4 gap-6"> ${relatedProducts?.map((product) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "key": product.id, "class": "" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ProductCard", $$ProductCard, { "product": product })} ` })}`)} </div> </div>`;
